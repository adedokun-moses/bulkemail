<template>
    <button @click="openModal()"><i class="fa fa-cloud-upload"></i> Import Text </button>
    <!-- The Modal -->
        ...
        <div class="dropzone-container">
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="formgroup">
                <textarea name="textfile" cols="87" rows="10" placeholder="Paste Text File " v-model="email_contact"></textarea>
              </div>
              <div class="formgroup">
  ...
  export default {
    ...
    methods: {
      ...
      submitFile() {
        if (this.email_contact == "" || this.email_group_name == ""){
          ...
          //alert(this.email_contact)
          this.$store.dispatch("addEmail", params);
